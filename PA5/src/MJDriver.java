...
public class MJDriver {
      ...
      public static void main(String args[]) 
      {
        ...
        try {
          ...
          // and parse
		Symbol parser_out = null;
		Node ast_root = null;
		try{
			parser_out  = parser.parse();
			ast_root = (Node) parser_out.value;
		}catch(Exception e){
			System.out.println("Error on parser.parse(): "+ e.getMessage());
			e.printStackTrace();
		}
		...
		//System.out.println("ast_root null?: "+(ast_root == null));
		  ...
		  if(globalST == null){System.out.println("globalST null");}
